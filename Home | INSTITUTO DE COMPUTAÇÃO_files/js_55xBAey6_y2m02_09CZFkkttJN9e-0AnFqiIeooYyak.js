...
$( ".ictheme-menu li:last-child .fa.fa-arrow-right.submenu-right-arrow" ).removeClass("fa fa-arrow-right submenu-right-arrow").addClass( "fa fa-arrow-left submenu-left-arrow" );
